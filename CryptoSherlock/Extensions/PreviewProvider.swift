...
class DeveloperPreview {
    ...
    let stat1 = StatisticModel(title: "Market Cap", value: "$77.7Bn", percetageChange: 47.69)
    let stat2 = StatisticModel(title: "Total Volume", value: "$1.66Tr")
    let stat3 = StatisticModel(title: "Portfolio Value", value: "$50.4k", percetageChange: -12.34)
